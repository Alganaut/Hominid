...
public class IncendiaryAnimations {
        ...
        public static final AnimationDefinition ANIM_INCENDIARY_IGNITING = AnimationDefinition.Builder.withLength(3.5F)
                .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        ...
                        new Keyframe(1.4583F, KeyframeAnimations.degreeVec(2.5213F, 3.9535F, -0.3823F), AnimationChannel.Interpolations.CATMULLROM),
                        ...
                        new Keyframe(3.25F, KeyframeAnimations.degreeVec(135.0F, 0.0F, 80.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("righter_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        ...
                        new Keyframe(1.2917F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.6667F, KeyframeAnimations.degreeVec(-42.3384F, 0.2179F, -2.4905F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("righter_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
                ...
                .addAnimation("tank", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        ...
                        new Keyframe(1.2917F, KeyframeAnimations.degreeVec(0.0F, 270.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(2.0417F, KeyframeAnimations.degreeVec(0.0F, 180.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(2.375F, KeyframeAnimations.degreeVec(0.0F, 180.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(2.75F, KeyframeAnimations.degreeVec(0.0F, 180.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(3.0417F, KeyframeAnimations.degreeVec(0.0F, 180.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(3.0823F, KeyframeAnimations.degreeVec(0.0F, 180.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("tank", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(0.6667F, KeyframeAnimations.posVec(7.0F, 2.0F, -9.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.2917F, KeyframeAnimations.posVec(3.0F, 2.0F, -18.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(2.0417F, KeyframeAnimations.posVec(7.0F, 2.0F, -8.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(3.0417F, KeyframeAnimations.posVec(7.0F, 2.0F, -8.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(3.0823F, KeyframeAnimations.posVec(7.0F, 2.0F, -8.0F), AnimationChannel.Interpolations.LINEAR),
