...
public class IncendiaryModel<T extends Incendiary> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition torso = incendiary.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -12.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(16, 32).addBox(-4.0F, -12.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -12.0F, 0.0F));

        PartDefinition back_tank = torso.addOrReplaceChild("back_tank", CubeListBuilder.create().texOffs(0, 33).addBox(-5.0F, -8.0F, -1.0F, 6.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 43).addBox(-6.0F, -7.0F, -1.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -3.0F, 3.0F));
        ...
        PartDefinition right_arm = torso.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(-5.0F, -10.0F, 0.0F, 0.1308F, -0.0057F, 0.0433F));
        ...
        PartDefinition tank = right_arm.addOrReplaceChild("tank", CubeListBuilder.create().texOffs(0, 33).addBox(-6.0F, -3.0F, -1.0F, 6.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(-2, 43).addBox(-7.0F, -2.0F, -1.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.025F, 0.0F, -9.025F, 0.0F, -1.5708F, 0.0F));

        PartDefinition oil = tank.addOrReplaceChild("oil", CubeListBuilder.create().texOffs(-6, 45).addBox(-0.5F, 0.0F, -6.0F, 1.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.5F, -2.0F, -1.0F));
