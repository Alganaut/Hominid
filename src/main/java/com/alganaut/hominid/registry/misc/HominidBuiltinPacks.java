...
public class HominidBuiltinPacks {
    ...
    public static void rpHominidRetextures(AddPackFindersEvent event) {
        ...
        PackMetadataSection metadata = new PackMetadataSection(Component.literal("Changes vanilla and modded mobs to work with Hominid"), SharedConstants.getCurrentVersion().getPackVersion(PackType.CLIENT_RESOURCES));
